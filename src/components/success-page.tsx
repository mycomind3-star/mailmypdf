      ...
      <div className="mx-auto max-w-2xl">
        <Card className="p-8 text-center">
          ...
          <p className="mt-4 text-base leading-7 text-[color:var(--muted)]">
            Your letter is moving into provider processing. You will be redirected to the secure order page shortly.
          </p>
          ...
          <div className="mt-6 rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface-muted)] p-4 text-left text-sm text-[color:var(--muted)]">
            ...
            <p className="mt-1">
              We’ll show the order status page next. If a provider issue appears, the order will land in manual review.
            </p>
          </div>
          {activeOrder ? (
